...
CREATE TABLE "Prefences" (
    ...
    CONSTRAINT "Prefences_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Prefences_userId_key" ON "Prefences"("userId");
...
-- AddForeignKey
ALTER TABLE "Prefences" ADD CONSTRAINT "Prefences_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
